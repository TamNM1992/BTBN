...
namespace BaoTangBn.API.Controllers
{
    ...
    [ApiController]
    public class KhaiQuatKhaoCoHoc_ViewerController : ControllerBase
    {
        private IKhaiQuatKhaoCoHocService _KhaiQuatKhaoCoHocService;
        private readonly IMapper _mapper;
        public KhaiQuatKhaoCoHoc_ViewerController(IKhaiQuatKhaoCoHocService KhaiQuatKhaoCoHocService, IMapper mapper)
        {
        ...
        public IActionResult GetListAndPaging(FilterBase filter)
        {
            ...
            try
            {
                var temp = _KhaiQuatKhaoCoHocService.GetList(false).ToList();
        ...
        public IActionResult GetRelated(Guid IDBaiViet, int pre_count, int next_count)
        {
            ...
            try
            {
                var temp = _KhaiQuatKhaoCoHocService.GetRelated(IDBaiViet, pre_count, next_count).ToList();
        ...
        public IActionResult ShowDetails(Guid ID)
        {
            ...
            try
            {
                var temp = _KhaiQuatKhaoCoHocService.ShowDetails(ID);
