...
namespace BaoTangBn.API.Controllers
{
    ...
    [ApiController]
    public class CongTacSuuTam_ViewerController : ControllerBase
    {
        private ICongTacSuuTamService _CongTacSuuTamService;
        private readonly IMapper _mapper;
        public CongTacSuuTam_ViewerController(ICongTacSuuTamService CongTacSuuTamService, IMapper mapper)
        {
            _CongTacSuuTamService = CongTacSuuTamService;
            _mapper = mapper;
        }
        ...
        public IActionResult GetListAndPaging(FilterBase filter)
        {
            ...
            try
            {
                var temp = _CongTacSuuTamService.GetList(false).ToList();
        ...
        public IActionResult GetRelated(Guid IDBaiViet, int pre_count, int next_count)
        {
            ...
            try
            {
                var temp = _CongTacSuuTamService.GetRelated(IDBaiViet, pre_count, next_count).ToList();
        ...
        public IActionResult ShowDetails(Guid ID)
        {
            ...
            try
            {
                var temp = _CongTacSuuTamService.ShowDetails(ID);
