...
namespace BaoTangBn.API.Controllers
{
    ...
    [ApiController]
    public class SuKienSapDienRa_ViewerController : ControllerBase
    {
        private ISuKienSapDienRaService _SuKienSapDienRaService;
        private readonly IMapper _mapper;
        public SuKienSapDienRa_ViewerController(ISuKienSapDienRaService SuKienSapDienRaService, IMapper mapper)
        {
            _SuKienSapDienRaService = SuKienSapDienRaService;
            _mapper = mapper;
        }
        ...
        public IActionResult GetListAndPaging(FilterBase filter)
        {
            ...
            try
            {
                var temp = _SuKienSapDienRaService.GetList(false).ToList();
        ...
        public IActionResult GetRelated(Guid IDBaiViet, int pre_count, int next_count)
        {
            ...
            try
            {
                var temp = _SuKienSapDienRaService.GetRelated(IDBaiViet, pre_count, next_count).ToList();
        ...
        public IActionResult ShowDetails(Guid ID)
        {
            ...
            try
            {
                var temp = _SuKienSapDienRaService.ShowDetails(ID);
