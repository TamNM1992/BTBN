...
namespace BaoTangBn.API.Controllers
{
    ...
    [ApiController]
    public class CacBoSuuTap_ViewerController : ControllerBase
    {
        private ICacBoSuuTapService _CacBoSuuTapService;
        private readonly IMapper _mapper;
        public CacBoSuuTap_ViewerController(ICacBoSuuTapService CacBoSuuTapService, IMapper mapper)
        {
        ...
        public IActionResult GetListAndPaging(FilterBase filter)
        {
            ...
            try
            {
                var temp = _CacBoSuuTapService.GetList(false).ToList();
        ...
        public IActionResult GetRelated(Guid IDBaiViet, int pre_count, int next_count)
        {
            ...
            try
            {
                var temp = _CacBoSuuTapService.GetRelated(IDBaiViet, pre_count, next_count).ToList();
        ...
        public IActionResult ShowDetails(Guid ID)
        {
            ...
            try
            {
                var temp = _CacBoSuuTapService.ShowDetails(ID);
