...
namespace BaoTangBn.API.Controllers
{
    ...
    [ApiController]
    public class BaoVatQuocGia_ViewerController : ControllerBase
    {
        private IBaoVatQuocGiaService _BaoVatQuocGiaService;
        private readonly IMapper _mapper;
        public BaoVatQuocGia_ViewerController(IBaoVatQuocGiaService BaoVatQuocGiaService, IMapper mapper)
        {
        ...
        public IActionResult GetListAndPaging(FilterBase filter)
        {
            ...
            try
            {
                var temp = _BaoVatQuocGiaService.GetList(false).ToList();
        ...
        public IActionResult GetRelated(Guid IDBaiViet, int pre_count, int next_count)
        {
            ...
            try
            {
                var temp = _BaoVatQuocGiaService.GetRelated(IDBaiViet, pre_count, next_count).ToList();
        ...
        public IActionResult ShowDetails(Guid ID)
        {
            ...
            try
            {
                var temp = _BaoVatQuocGiaService.ShowDetails(ID);
