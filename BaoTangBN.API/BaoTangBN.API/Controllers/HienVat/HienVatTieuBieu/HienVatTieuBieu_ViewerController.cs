...
namespace BaoTangBn.API.Controllers
{
    ...
    [ApiController]
    public class HienVatTieuBieu_ViewerController : ControllerBase
    {
        private IHienVatTieuBieuService _HienVatTieuBieuService;
        private readonly IMapper _mapper;
        public HienVatTieuBieu_ViewerController(IHienVatTieuBieuService HienVatTieuBieuService, IMapper mapper)
        {
        ...
        public IActionResult GetListAndPaging(FilterBase filter)
        {
            ...
            try
            {
                var temp = _HienVatTieuBieuService.GetList(false).ToList();
        ...
        public IActionResult GetRelated(Guid IDBaiViet, int pre_count, int next_count)
        {
            ...
            try
            {
                var temp = _HienVatTieuBieuService.GetRelated(IDBaiViet, pre_count, next_count).ToList();
        ...
        public IActionResult ShowDetails(Guid ID)
        {
            ...
            try
            {
                var temp = _HienVatTieuBieuService.ShowDetails(ID);
